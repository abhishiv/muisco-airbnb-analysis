...
(function () {
	...
	function moveScroll(element, dir, offset = 0) {
		let amount = window.spatialScrollAmount ? Math.abs(window.spatialScrollAmount) : 40;
		if (element) {
			switch (dir) {
				case 'left': element.scrollLeft -= (amount + offset); break;
				case 'right': element.scrollLeft += (amount + offset); break;
				case 'up': element.scrollTop -= (amount + offset); break;
				case 'down': element.scrollTop += (amount + offset); break;
			}
		}
		window.spatialScrollAmount = null
	}
